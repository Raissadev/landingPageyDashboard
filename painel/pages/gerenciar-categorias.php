<?php
	if(isset($_GET['excluir'])){
		...
		//Para deletar em massa (categorias + as noticias com essa categoria)
		...
		$noticias->execute(array($idExcluir));
		//Fim do evento deletar em massa
...
<div class="box-content">
	<h2><i class="fa fa-id-card-o" aria-hidden="true"></i> Categorias Cadastrados</h2>
